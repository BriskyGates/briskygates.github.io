...
要更新网站内容，编辑 `assets/data/` 下的配置文件，然后提交并推送更改：

```bash
git add assets/data/homeConfig.json assets/data/homeConfig.en.json
...
- 确认 `assets/data/homeConfig.json` 可以正常访问
- 运行 `npm test` 检查核心逻辑与配置文件
