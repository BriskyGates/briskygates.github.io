...
showcase_updates = {
    ...
    "onchain_token_monitor": {"title": "High-Freq Asset Trading Monitor", "description": "Built low-latency trading data listening nodes, combined with Redis caching for high-speed deduplication and analysis, pushing core trading intelligence in milliseconds."},
